...
const MyProfile = () => {
  ...
  const profile = currentPetProfile || {
    ...
    coverImage: 'https://images.unsplash.com/photo-1612536057832-2ff7ead58194?w=800&h=400&fit=crop',
    breed: '柯基犬',
    age: 3,
    ...
    posts: 89,
    owner: '妮妮主人',
    ownerAvatar: 'https://images.unsplash.com/photo-1612536057832-2ff7ead58194?w=100&h=100&fit=crop',
    createdAt: new Date()
  };
